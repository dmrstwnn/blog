    ...
    <section class="dark:bg-gray-900">
        <div class="py-8 px-4 mx-auto max-w-screen-xl  lg:py-16 lg:px-6">
            <div class="mx-auto max-w-screen-sm text-center lg:mb-8 mb-4">
                ...
                <div class="mt-10">
                    <a href="/create" type="button" class="py-2 px-3 bg-cyan-500 hover:bg-cyan-600 active:bg-cyan-700 text-white rounded-full border w-48 border-black font-bold hover:shadow-[4px_4px_0px_rgba(0,0,0,1)]">Create Artikel</a>
                </div>
            </div> 
            ...
            <div class="grid gap-5 lg:grid-cols-3 grid-cols-1">
                ...
                <article class="p-6 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <div class="flex justify-between items-center">
                        ...
                        <a href="/post/{{ $article->id }}" class="py-2 px-3 flex items-center bg-transparent rounded-full border w-36 border-black font-bold hover:shadow-[4px_4px_0px_rgba(0,0,0,1)]">
                            Read more
